-- =============================================
-- Fix v3: Corregir vehículos que tienen venta activa pero su status no es "Vendido"
-- Escenario: vehicles_sales existe con status IN ('approved', 'pending', 'completed')
-- pero el vehículo sigue en "Publicado" u otro estado.
-- =============================================

-- Paso 1: Mover a "Vendido" por nombre (busca el estado "Vendido" del tenant)
UPDATE vehicles v
...
-- Paso 2: Fallback para tenants que no tienen un estado llamado "Vendido"
-- Usa el estado con el order más alto
UPDATE vehicles v
SET status_id = (
    SELECT cvs.id
