-- =====================================================
-- ChileAutos Integration - Complete Setup Script
-- Run this in Supabase Dashboard > SQL Editor
-- =====================================================

-- 1. Create ChileAutos integration table
...
-- 2. Create ChileAutos listing table
...
-- 5. Drop and recreate policies for chileautos_integration
...
-- 6. Drop and recreate policies for chileautos_listing
...
-- 7. Grant permissions for service role (for edge functions)
...
-- 8. Create function to update vehicles_published count
...
-- 9. Create trigger (drop first if exists)
DROP TRIGGER IF EXISTS trigger_update_chileautos_count ON chileautos_listing;
...
-- Done!
SELECT 'ChileAutos tables created successfully!' as result;
