...
interface ConsignmentsFormEmbedProps {
  bgColor?: string;
  textColor?: string;
  accentColor?: string;
  title?: string;
...
export const ConsignmentsFormEmbed = ({
  bgColor = '#ffffff',
  textColor = '#111827',
  accentColor = '#3b82f6',
  title = '',
  subtitle = '',
}: ConsignmentsFormEmbedProps) => {
          ...
          <div className="rounded-xl p-8 border" style={{ backgroundColor: infoBg, borderColor: cardBorder }}>
            ...
            <div className="space-y-5 mb-8">
              {[
                ...
                { step: '2', title: 'Evaluación', desc: 'Nuestro equipo evalúa tu vehículo y te contactamos.' },
                { step: '3', title: 'Publicación', desc: 'Publicamos tu vehículo en múltiples plataformas.' },
                { step: '4', title: 'Venta', desc: 'Gestionamos todo el proceso hasta cerrar la venta.' },
              ].map((item, i) => (
...
ConsignmentsFormEmbed.craft = {
  displayName: 'ConsignmentsFormEmbed',
  props: {
    bgColor: '#ffffff',
    textColor: '#111827',
    accentColor: '#3b82f6',
