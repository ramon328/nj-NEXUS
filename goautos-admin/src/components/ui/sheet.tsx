...
interface SheetContentProps
  ...
  /** Si true, no cierra al clic afuera ni con Escape (evita perder datos de un
   *  formulario). Opt-in: por defecto el comportamiento no cambia. */
  guardClose?: boolean;
}
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = 'right', className, children, guardClose, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
...
// Versión sin el botón X de cerrar
const SheetContentNoClose = React.forwardRef<
  React.ElementRef<typeof SheetPrimitive.Content>,
  SheetContentProps
>(({ side = 'right', className, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay className='bg-black/20 backdrop-blur-[6px]' />
    <SheetPrimitive.Content
      ref={ref}
      className={cn(sheetVariants({ side }), 'rounded-r-xl', className)}
      {...props}
    >
      {children}
    </SheetPrimitive.Content>
