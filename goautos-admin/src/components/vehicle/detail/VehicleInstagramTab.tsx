...
export function VehicleInstagramTab({ vehicle, clientId }: Props) {
  ...
  if (!vehicle.instagram_post_id) {
    return (
      <div className="p-6 text-center text-muted-foreground">
        {t('instagram.vehicleTab.noPost')}
      </div>
    );
  }

  if (isLoading) {
    return <div className="animate-pulse h-[300px] bg-gray-100 rounded-lg m-6" />;
  }
