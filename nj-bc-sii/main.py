...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_todo.add_argument("--salida", default="~/Desktop/sii-datos",
                        help="Carpeta destino")

    p_pdf = sub.add_parser("pdf", help="Genera PDF legibles de lo ya descargado")
    p_pdf.add_argument("--salida", default="~/Desktop/sii-datos", help="Carpeta con los datos")
    p_pdf.add_argument("--pdf-dir", default="~/Desktop", help="Dónde dejar las carpetas de PDF")
    p_pdf.add_argument("--empresa", default="Empresa", help="Nombre para el encabezado")

    p_cte = sub.add_parser("carpeta", help="Carpeta tributaria (PDF)")
    p_cte.add_argument("--salida", default="~/Desktop/carpeta-tributaria.pdf",
                       help="Ruta del PDF de salida")
    p_cte.add_argument("--empresa", default="Empresa", help="Nombre para el encabezado")
